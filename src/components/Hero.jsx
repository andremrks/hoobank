    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
          ...
          <p className={`${styles.paragraph} ml-2 ss:text-[18px] text-[14px]`}>
            <span className="text-white ss:text-[18px] text-[14px]">20%</span> DISCOUNT FOR {" "}
            <span className="text-white ss:text-[18px] text-[14px]">1 MONTH</span> ACCOUNT
          </p>
        </div>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          ...
          <div className="ss:flex hidden md:mr-4 mr-0 heartbeat">
            <GetStarted />
          </div>
        </div>
      ...
      <div className={`ss:hidden ${styles.flexCenter} heartbeat`}>
        <GetStarted />
      </div>
    </section>
  )
